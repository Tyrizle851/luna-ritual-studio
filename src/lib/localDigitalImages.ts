...
// CORRECT TITLES FROM affirmations.ts:
// aff-001: I am worthy of rest (NO LOCAL IMAGE)
...
// aff-008: Today, I honor myself (NO LOCAL IMAGE)
...
// aff-014: I choose peace over perfection (NO LOCAL IMAGE)
...
// IDs that have user-provided local images (21 total - missing aff-001, aff-008, aff-014)
