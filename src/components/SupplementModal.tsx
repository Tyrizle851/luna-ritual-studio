...
// Category-specific labels for Supplements
const getImageLabel = (variationType: string): string => {
  switch (variationType) {
    case "original": return "Package";
    case "lifestyle": return "In Use";
    case "detail": return "Formula";
...
export const SupplementModal = ({ product, open, onOpenChange }: SupplementModalProps) => {
  ...
  const galleryImages = images.length > 0 
    ...
    : [{ url: product.image, label: "Package" }];
