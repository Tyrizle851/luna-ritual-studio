    ...
    <div className="relative">
      ...
      >
        {affirmations.map((affirmation, index) => (
          ...
          >
            <div className="relative h-full bg-white/80 rounded-xl border border-[#EBDDD1]/60 shadow-[0_4px_16px_rgba(0,0,0,0.04)] overflow-hidden group hover:shadow-[0_8px_24px_rgba(139,107,84,0.10)] hover:-translate-y-1 transition-all duration-300 mx-[-6px]">
